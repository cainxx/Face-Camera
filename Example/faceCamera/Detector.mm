...
//===========================================================================
//===========================================================================
std::vector<cv::Mat> Detector::getResponsesForRefShape(double scale)
{
...
//===========================================================================
std::vector<cv::Mat> Detector::getResponsesForRefShape(cv::Mat r, double *sc_)
{
    std::vector<cv::Mat> resp(prob_.size());
...
void Detector::setReferenceShape(cv::Mat& s)
{
...
void DetectorNCC::ReadBinary(std::ifstream &s, bool readType)
{
...
void DetectorNCC::Write(std::ofstream &s, bool binary)
{
    assert(binary);
...
void DetectorNCC::Read(std::ifstream &, bool)
{
...
void DetectorNCC::Load(std::string fname, bool binary)
{
    std::ifstream s;
    assert(binary);
...
void DetectorNCC::Save(std::string fname, bool binary)
{
    std::ofstream s;
    assert(binary);
    s.open(fname.c_str(), std::ios::binary);
...
bool DetectorNCC::response(cv::Mat & im, cv::Mat & sh,
                      cv::Size wSize,
                      cv::Mat& visi)
{
    
    __block cv::Mat simTransfMat;
    CalcSimT(_refs, sh, simTransfMat);
    
    int n = sh.rows/2;
    __block cv::Mat shape = sh.reshape(0,2);
